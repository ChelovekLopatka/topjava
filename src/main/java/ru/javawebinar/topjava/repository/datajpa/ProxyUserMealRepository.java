...
public interface ProxyUserMealRepository extends JpaRepository<UserMeal, Integer> {
    ...
    UserMeal save(@Param("datetime") LocalDateTime datetime, @Param("calories") int calories,
                  @Param("description") String description, @Param("id") int id, @Param("userId") int userId);
