...
//        @NamedQuery(name = UserMeal.UPDATE, query = "UPDATE UserMeal m SET m.dateTime = ?1, m.calories= ?2," +
...
public class UserMeal extends BaseEntity {
    ...
    public static final String UPDATE = "UserMeal.getUpdate";
    public static final String INSERT = "UserMeal.insert";
